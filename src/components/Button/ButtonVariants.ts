...
export const variantClasses: Record<Colors, Record<Variant, string>> = {
  default: {
    ...
    faint: "bg-transparent text-neutral-600 hover:bg-neutral-500/20",
  },
  primary: {
    ...
    faint: "bg-transparent text-blue-600 hover:bg-blue-600/20",
  },
  warning: {
    ...
    faint: "bg-transparent text-amber-500 hover:bg-amber-500/20",
  },
  danger: {
    ...
    faint: "bg-transparent text-rose-500 hover:bg-rose-500/20",
  },
  secondary: {
    ...
    faint: "bg-transparent text-violet-500 hover:bg-violet-500/20",
  },
  success: {
    ...
    faint: "bg-transparent text-green-500 hover:bg-green-500/20",
  },
